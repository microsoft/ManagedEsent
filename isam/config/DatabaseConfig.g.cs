...
namespace Microsoft.Database.Isam.Config
{
    ...
    public partial class DatabaseConfig : ConfigSetBase
    {
        ...
        /// </summary>
        internal const int ParamMaxValueInvalid = 250; // should be equal to JET_paramMaxValueInvalid
        ...
        {
            DatabaseConfig.ParamTable[0] = new ParamDef(0, false, false, typeof(string)); // JET_paramSystemPath
            DatabaseConfig.ParamTable[1] = new ParamDef(1, false, false, typeof(string)); // JET_paramTempPath
            DatabaseConfig.ParamTable[2] = new ParamDef(2, false, false, typeof(string)); // JET_paramLogFilePath
            DatabaseConfig.ParamTable[3] = new ParamDef(3, false, false, typeof(string)); // JET_paramBaseName
            DatabaseConfig.ParamTable[4] = new ParamDef(4, false, false, typeof(string)); // JET_paramEventSource
            DatabaseConfig.ParamTable[5] = new ParamDef(5, false, false, typeof(int)); // JET_paramMaxSessions
            DatabaseConfig.ParamTable[6] = new ParamDef(6, false, false, typeof(int)); // JET_paramMaxOpenTables
            DatabaseConfig.ParamTable[8] = new ParamDef(8, false, false, typeof(int)); // JET_paramMaxCursors
            DatabaseConfig.ParamTable[9] = new ParamDef(9, false, false, typeof(int)); // JET_paramMaxVerPages
            DatabaseConfig.ParamTable[10] = new ParamDef(10, false, false, typeof(int)); // JET_paramMaxTemporaryTables
            DatabaseConfig.ParamTable[11] = new ParamDef(11, false, false, typeof(int)); // JET_paramLogFileSize
            DatabaseConfig.ParamTable[12] = new ParamDef(12, false, false, typeof(int)); // JET_paramLogBuffers
            DatabaseConfig.ParamTable[16] = new ParamDef(16, false, false, typeof(CommitTransactionGrbit)); // JET_paramCommitDefault
            DatabaseConfig.ParamTable[17] = new ParamDef(17, false, false, typeof(bool)); // JET_paramCircularLog
            DatabaseConfig.ParamTable[18] = new ParamDef(18, false, false, typeof(int)); // JET_paramDbExtensionSize
            DatabaseConfig.ParamTable[19] = new ParamDef(19, false, false, typeof(int)); // JET_paramPageTempDBMin
            DatabaseConfig.ParamTable[20] = new ParamDef(20, false, false, typeof(int)); // JET_paramPageFragment
            DatabaseConfig.ParamTable[23] = new ParamDef(23, false, false, typeof(int)); // JET_paramCacheSizeMax
            DatabaseConfig.ParamTable[24] = new ParamDef(24, false, false, typeof(int)); // JET_paramCheckpointDepthMax
            DatabaseConfig.ParamTable[25] = new ParamDef(25, true, false, typeof(int)); // JET_paramLRUKCorrInterval
            DatabaseConfig.ParamTable[26] = new ParamDef(26, true, false, typeof(int)); // JET_paramLRUKHistoryMax
            DatabaseConfig.ParamTable[27] = new ParamDef(27, true, false, typeof(int)); // JET_paramLRUKPolicy
            DatabaseConfig.ParamTable[28] = new ParamDef(28, true, false, typeof(int)); // JET_paramLRUKTimeout
            DatabaseConfig.ParamTable[30] = new ParamDef(30, true, false, typeof(int)); // JET_paramOutstandingIOMax
            DatabaseConfig.ParamTable[31] = new ParamDef(31, false, false, typeof(int)); // JET_paramStartFlushThreshold
            DatabaseConfig.ParamTable[32] = new ParamDef(32, false, false, typeof(int)); // JET_paramStopFlushThreshold
            DatabaseConfig.ParamTable[34] = new ParamDef(34, false, false, typeof(string)); // JET_paramRecovery
            DatabaseConfig.ParamTable[35] = new ParamDef(35, false, false, typeof(int)); // JET_paramEnableOnlineDefrag
            DatabaseConfig.ParamTable[37] = new ParamDef(37, false, false, typeof(IntPtr)); // JET_paramPrintFunction
            DatabaseConfig.ParamTable[38] = new ParamDef(38, false, false, typeof(int)); // JET_paramTransactionLevel
            DatabaseConfig.ParamTable[39] = new ParamDef(39, false, false, typeof(int)); // JET_paramRFS2IOsPermitted
            DatabaseConfig.ParamTable[40] = new ParamDef(40, false, false, typeof(int)); // JET_paramRFS2AllocsPermitted
            DatabaseConfig.ParamTable[41] = new ParamDef(41, false, false, typeof(int)); // JET_paramCacheSize
            DatabaseConfig.ParamTable[42] = new ParamDef(42, false, false, typeof(int)); // JET_paramCacheRequests
            DatabaseConfig.ParamTable[43] = new ParamDef(43, false, false, typeof(int)); // JET_paramCacheHits
            DatabaseConfig.ParamTable[45] = new ParamDef(45, false, false, typeof(bool)); // JET_paramEnableIndexChecking
            DatabaseConfig.ParamTable[46] = new ParamDef(46, false, false, typeof(bool)); // JET_paramEnableTempTableVersioning
            DatabaseConfig.ParamTable[49] = new ParamDef(49, false, false, typeof(string)); // JET_paramEventSourceKey
            DatabaseConfig.ParamTable[50] = new ParamDef(50, false, false, typeof(bool)); // JET_paramNoInformationEvent
            DatabaseConfig.ParamTable[51] = new ParamDef(51, false, false, typeof(EventLoggingLevels)); // JET_paramEventLoggingLevel
            DatabaseConfig.ParamTable[52] = new ParamDef(52, false, false, typeof(bool)); // JET_paramDeleteOutOfRangeLogs
            DatabaseConfig.ParamTable[53] = new ParamDef(53, false, false, typeof(int)); // JET_paramAccessDeniedRetryPeriod
            DatabaseConfig.ParamTable[54] = new ParamDef(54, false, false, typeof(bool)); // JET_paramEnableIndexCleanup
            DatabaseConfig.ParamTable[55] = new ParamDef(55, false, false, typeof(bool)); // JET_paramFlight_AllowTempTableVersioningonPassives
            DatabaseConfig.ParamTable[56] = new ParamDef(56, false, false, typeof(int)); // JET_paramElasticWaypointLatency
            DatabaseConfig.ParamTable[57] = new ParamDef(57, false, false, typeof(bool)); // JET_paramFlight_SynchronousLVCleanup
            DatabaseConfig.ParamTable[58] = new ParamDef(58, false, false, typeof(int)); // JET_paramFlight_RBSRevertIOUrgentLevel
            DatabaseConfig.ParamTable[59] = new ParamDef(59, false, false, typeof(bool)); // JET_paramFlight_EnableXpress10Compression
            DatabaseConfig.ParamTable[60] = new ParamDef(60, false, false, typeof(int)); // JET_paramCacheSizeMin
            DatabaseConfig.ParamTable[63] = new ParamDef(63, false, false, typeof(int)); // JET_paramPreferredVerPages
            DatabaseConfig.ParamTable[64] = new ParamDef(64, false, true, typeof(int)); // JET_paramDatabasePageSize
            DatabaseConfig.ParamTable[65] = new ParamDef(65, false, false, typeof(bool)); // JET_paramDisableCallbacks
            DatabaseConfig.ParamTable[68] = new ParamDef(68, false, false, typeof(int)); // JET_paramFlight_RBSMaxTableDeletePages
            DatabaseConfig.ParamTable[69] = new ParamDef(69, false, false, typeof(bool)); // JET_paramLogFileCreateAsynch
            DatabaseConfig.ParamTable[71] = new ParamDef(71, false, false, typeof(bool)); // JET_paramZeroDatabaseDuringBackup
            DatabaseConfig.ParamTable[72] = new ParamDef(72, false, false, typeof(JET_UNICODEINDEX)); // JET_paramUnicodeIndexDefault
            DatabaseConfig.ParamTable[73] = new ParamDef(73, false, false, typeof(IntPtr)); // JET_paramRuntimeCallback
            DatabaseConfig.ParamTable[74] = new ParamDef(74, false, false, typeof(bool)); // JET_paramFlight_RBSDbScanRaiseCorruptionRevertedFDP
            DatabaseConfig.ParamTable[75] = new ParamDef(75, false, false, typeof(bool)); // JET_paramFlight_RBSAllowTooSoonNonRevertableDelete
            DatabaseConfig.ParamTable[77] = new ParamDef(77, false, false, typeof(bool)); // JET_paramCleanupMismatchedLogFiles
            DatabaseConfig.ParamTable[79] = new ParamDef(79, false, false, typeof(int)); // JET_paramRecoveryCurrentLogfile
            DatabaseConfig.ParamTable[80] = new ParamDef(80, false, false, typeof(int)); // JET_paramFlight_RBSForceRollIntervalSec
            DatabaseConfig.ParamTable[81] = new ParamDef(81, true, false, typeof(int)); // JET_paramGlobalMinVerPages
            DatabaseConfig.ParamTable[82] = new ParamDef(82, false, false, typeof(int)); // JET_paramOSSnapshotTimeout
            DatabaseConfig.ParamTable[83] = new ParamDef(83, false, false, typeof(bool)); // JET_paramFlight_EnableScanCheckFDPDeleteFlags
            DatabaseConfig.ParamTable[84] = new ParamDef(84, false, false, typeof(int)); // JET_paramFlight_NewQueueOptions
            DatabaseConfig.ParamTable[85] = new ParamDef(85, false, false, typeof(int)); // JET_paramFlight_ConcurrentMetedOps
            DatabaseConfig.ParamTable[86] = new ParamDef(86, false, false, typeof(int)); // JET_paramFlight_LowMetedOpsThreshold
            DatabaseConfig.ParamTable[87] = new ParamDef(87, false, false, typeof(int)); // JET_paramFlight_MetedOpStarvedThreshold
            DatabaseConfig.ParamTable[88] = new ParamDef(88, false, false, typeof(int)); // JET_paramFlight_MaxRBSBuffers
            DatabaseConfig.ParamTable[89] = new ParamDef(89, false, false, typeof(int)); // JET_paramFlight_NodeOrderChecking
            DatabaseConfig.ParamTable[90] = new ParamDef(90, true, false, typeof(bool)); // JET_paramFlight_EnableSpBuffOptimizations
            DatabaseConfig.ParamTable[91] = new ParamDef(91, false, false, typeof(int)); // JET_paramFlight_RBSRollIntervalSec
            DatabaseConfig.ParamTable[92] = new ParamDef(92, false, false, typeof(bool)); // JET_paramFlight_EnableRBSRollRequiredPostRequiredRange
            DatabaseConfig.ParamTable[93] = new ParamDef(93, false, false, typeof(bool)); // JET_paramFlight_RBSCleanupEnabled
            DatabaseConfig.ParamTable[94] = new ParamDef(94, false, false, typeof(int)); // JET_paramRBSLowDiskSpaceThresholdGb
            DatabaseConfig.ParamTable[95] = new ParamDef(95, false, false, typeof(int)); // JET_paramRBSMaxSpaceWhenLowDiskSpaceGb
            DatabaseConfig.ParamTable[96] = new ParamDef(96, false, false, typeof(int)); // JET_paramFlight_RBSMaxTimeSpanSec
            DatabaseConfig.ParamTable[97] = new ParamDef(97, false, false, typeof(int)); // JET_paramFlight_RBSCleanupIntervalMinSec
            DatabaseConfig.ParamTable[98] = new ParamDef(98, false, false, typeof(JET_ExceptionAction)); // JET_paramExceptionAction
            DatabaseConfig.ParamTable[99] = new ParamDef(99, true, false, typeof(int)); // JET_paramEventLogCache
            DatabaseConfig.ParamTable[100] = new ParamDef(100, false, false, typeof(bool)); // JET_paramCreatePathIfNotExist
            DatabaseConfig.ParamTable[101] = new ParamDef(101, true, false, typeof(int)); // JET_paramPageHintCacheSize
            DatabaseConfig.ParamTable[102] = new ParamDef(102, false, false, typeof(bool)); // JET_paramOneDatabasePerSession
            DatabaseConfig.ParamTable[104] = new ParamDef(104, true, false, typeof(int)); // JET_paramMaxInstances
            DatabaseConfig.ParamTable[105] = new ParamDef(105, false, false, typeof(int)); // JET_paramVersionStoreTaskQueueMax
            DatabaseConfig.ParamTable[107] = new ParamDef(107, true, false, typeof(bool)); // JET_paramDisablePerfmon
            DatabaseConfig.ParamTable[110] = new ParamDef(110, false, false, typeof(int)); // JET_paramIndexTuplesLengthMin
            DatabaseConfig.ParamTable[111] = new ParamDef(111, false, false, typeof(int)); // JET_paramIndexTuplesLengthMax
            DatabaseConfig.ParamTable[112] = new ParamDef(112, false, false, typeof(int)); // JET_paramIndexTuplesToIndexMax
            DatabaseConfig.ParamTable[113] = new ParamDef(113, false, false, typeof(string)); // JET_paramAlternateDatabaseRecoveryPath
            DatabaseConfig.ParamTable[114] = new ParamDef(114, false, false, typeof(bool)); // JET_paramFlight_ExtentPageCountCacheVerifyOnly
            DatabaseConfig.ParamTable[115] = new ParamDef(115, false, false, typeof(bool)); // JET_paramFlight_EnablePgnoFDPLastSetTime
            DatabaseConfig.ParamTable[116] = new ParamDef(116, false, false, typeof(bool)); // JET_paramFlight_EnableFDPDeleteFlagCheckOnExtentFreedRedo
            DatabaseConfig.ParamTable[117] = new ParamDef(117, false, false, typeof(bool)); // JET_paramFlight_RBSRaiseCorruptionOnRBSFDPToBeDeleted
            DatabaseConfig.ParamTable[118] = new ParamDef(118, false, false, typeof(int)); // JET_paramFlight_RBSLargeRevertableDeletePages
            DatabaseConfig.ParamTable[119] = new ParamDef(119, false, false, typeof(bool)); // JET_paramFlight_RBSRevertableDeleteIfTooSoonTimeNull
            DatabaseConfig.ParamTable[125] = new ParamDef(125, false, false, typeof(int)); // JET_paramCachedClosedTables
            DatabaseConfig.ParamTable[126] = new ParamDef(126, true, false, typeof(bool)); // JET_paramEnableFileCache
            DatabaseConfig.ParamTable[127] = new ParamDef(127, true, false, typeof(bool)); // JET_paramEnableViewCache
            DatabaseConfig.ParamTable[128] = new ParamDef(128, true, false, typeof(int)); // JET_paramVerPageSize
            DatabaseConfig.ParamTable[129] = new ParamDef(129, false, false, typeof(int)); // JET_paramConfiguration
            DatabaseConfig.ParamTable[130] = new ParamDef(130, false, false, typeof(bool)); // JET_paramEnableAdvanced
            DatabaseConfig.ParamTable[131] = new ParamDef(131, false, false, typeof(int)); // JET_paramMaxColtyp
            DatabaseConfig.ParamTable[132] = new ParamDef(132, false, false, typeof(int)); // JET_paramIndexTupleIncrement
            DatabaseConfig.ParamTable[133] = new ParamDef(133, false, false, typeof(int)); // JET_paramIndexTupleStart
            DatabaseConfig.ParamTable[134] = new ParamDef(134, false, false, typeof(int)); // JET_paramKeyMost
            DatabaseConfig.ParamTable[135] = new ParamDef(135, false, false, typeof(int)); // JET_paramCheckpointIOMax
            DatabaseConfig.ParamTable[136] = new ParamDef(136, false, false, typeof(LegacyFileNames)); // JET_paramLegacyFileNames
            DatabaseConfig.ParamTable[137] = new ParamDef(137, true, false, typeof(string)); // JET_paramTableClass1Name
            DatabaseConfig.ParamTable[138] = new ParamDef(138, true, false, typeof(string)); // JET_paramTableClass2Name
            DatabaseConfig.ParamTable[139] = new ParamDef(139, true, false, typeof(string)); // JET_paramTableClass3Name
            DatabaseConfig.ParamTable[140] = new ParamDef(140, true, false, typeof(string)); // JET_paramTableClass4Name
            DatabaseConfig.ParamTable[141] = new ParamDef(141, true, false, typeof(string)); // JET_paramTableClass5Name
            DatabaseConfig.ParamTable[142] = new ParamDef(142, true, false, typeof(string)); // JET_paramTableClass6Name
            DatabaseConfig.ParamTable[143] = new ParamDef(143, true, false, typeof(string)); // JET_paramTableClass7Name
            DatabaseConfig.ParamTable[144] = new ParamDef(144, true, false, typeof(string)); // JET_paramTableClass8Name
            DatabaseConfig.ParamTable[145] = new ParamDef(145, true, false, typeof(string)); // JET_paramTableClass9Name
            DatabaseConfig.ParamTable[146] = new ParamDef(146, true, false, typeof(string)); // JET_paramTableClass10Name
            DatabaseConfig.ParamTable[147] = new ParamDef(147, true, false, typeof(string)); // JET_paramTableClass11Name
            DatabaseConfig.ParamTable[148] = new ParamDef(148, true, false, typeof(string)); // JET_paramTableClass12Name
            DatabaseConfig.ParamTable[149] = new ParamDef(149, true, false, typeof(string)); // JET_paramTableClass13Name
            DatabaseConfig.ParamTable[150] = new ParamDef(150, true, false, typeof(string)); // JET_paramTableClass14Name
            DatabaseConfig.ParamTable[151] = new ParamDef(151, true, false, typeof(string)); // JET_paramTableClass15Name
            DatabaseConfig.ParamTable[152] = new ParamDef(152, false, false, typeof(int)); // JET_paramIOPriority
            DatabaseConfig.ParamTable[153] = new ParamDef(153, false, false, typeof(int)); // JET_paramWaypointLatency
            DatabaseConfig.ParamTable[155] = new ParamDef(155, true, false, typeof(bool)); // JET_paramDisableBlockVerification
            DatabaseConfig.ParamTable[156] = new ParamDef(156, false, false, typeof(bool)); // JET_paramEnablePersistedCallbacks
            DatabaseConfig.ParamTable[158] = new ParamDef(158, false, false, typeof(int)); // JET_paramPeriodicLogRolloverLLR
            DatabaseConfig.ParamTable[160] = new ParamDef(160, false, false, typeof(bool)); // JET_paramDefragmentSequentialBTrees
            DatabaseConfig.ParamTable[161] = new ParamDef(161, false, false, typeof(int)); // JET_paramDefragmentSequentialBTreesDensityCheckFrequency
            DatabaseConfig.ParamTable[162] = new ParamDef(162, true, false, typeof(int)); // JET_paramIOThrottlingTimeQuanta
            DatabaseConfig.ParamTable[163] = new ParamDef(163, false, false, typeof(int)); // JET_paramLVChunkSizeMost
            DatabaseConfig.ParamTable[164] = new ParamDef(164, true, false, typeof(int)); // JET_paramMaxCoalesceReadSize
            DatabaseConfig.ParamTable[165] = new ParamDef(165, true, false, typeof(int)); // JET_paramMaxCoalesceWriteSize
            DatabaseConfig.ParamTable[166] = new ParamDef(166, true, false, typeof(int)); // JET_paramMaxCoalesceReadGapSize
            DatabaseConfig.ParamTable[167] = new ParamDef(167, true, false, typeof(int)); // JET_paramMaxCoalesceWriteGapSize
            DatabaseConfig.ParamTable[169] = new ParamDef(169, false, false, typeof(int)); // JET_paramEnableDBScanInRecovery
            DatabaseConfig.ParamTable[170] = new ParamDef(170, false, false, typeof(int)); // JET_paramDbScanThrottle
            DatabaseConfig.ParamTable[171] = new ParamDef(171, false, false, typeof(int)); // JET_paramDbScanIntervalMinSec
            DatabaseConfig.ParamTable[172] = new ParamDef(172, false, false, typeof(int)); // JET_paramDbScanIntervalMaxSec
            DatabaseConfig.ParamTable[177] = new ParamDef(177, false, false, typeof(int)); // JET_paramCachePriority
            DatabaseConfig.ParamTable[178] = new ParamDef(178, false, false, typeof(int)); // JET_paramMaxTransactionSize
            DatabaseConfig.ParamTable[179] = new ParamDef(179, false, false, typeof(int)); // JET_paramPrereadIOMax
            DatabaseConfig.ParamTable[180] = new ParamDef(180, false, false, typeof(bool)); // JET_paramEnableDBScanSerialization
            DatabaseConfig.ParamTable[181] = new ParamDef(181, true, false, typeof(int)); // JET_paramHungIOThreshold
            DatabaseConfig.ParamTable[182] = new ParamDef(182, true, false, typeof(int)); // JET_paramHungIOActions
            DatabaseConfig.ParamTable[183] = new ParamDef(183, true, false, typeof(int)); // JET_paramMinDataForXpress
            DatabaseConfig.ParamTable[184] = new ParamDef(184, false, false, typeof(ShrinkDatabaseGrbit)); // JET_paramEnableShrinkDatabase
            DatabaseConfig.ParamTable[185] = new ParamDef(185, false, false, typeof(int)); // JET_paramFlight_CacheTraceSamplingRatio
            DatabaseConfig.ParamTable[186] = new ParamDef(186, true, false, typeof(string)); // JET_paramProcessFriendlyName
            DatabaseConfig.ParamTable[187] = new ParamDef(187, false, false, typeof(IntPtr)); // JET_paramDurableCommitCallback
            DatabaseConfig.ParamTable[189] = new ParamDef(189, false, false, typeof(string)); // JET_paramConfigStoreSpec
            DatabaseConfig.ParamTable[193] = new ParamDef(193, false, false, typeof(int)); // JET_paramPersistedLostFlushDetection
            DatabaseConfig.ParamTable[194] = new ParamDef(194, false, false, typeof(int)); // JET_paramEngineFormatVersion
            DatabaseConfig.ParamTable[214] = new ParamDef(214, false, false, typeof(bool)); // JET_paramUseFlushForWriteDurability
            DatabaseConfig.ParamTable[215] = new ParamDef(215, false, false, typeof(bool)); // JET_paramEnableRBS
            DatabaseConfig.ParamTable[216] = new ParamDef(216, false, false, typeof(string)); // JET_paramRBSFilePath
            DatabaseConfig.ParamTable[217] = new ParamDef(217, true, false, typeof(int)); // JET_paramPerfmonRefreshInterval
            DatabaseConfig.ParamTable[220] = new ParamDef(220, true, false, typeof(int)); // JET_paramFlight_BufferManagerChecking
            DatabaseConfig.ParamTable[221] = new ParamDef(221, false, false, typeof(bool)); // JET_paramFlight_AllowLogBufferLargerThanLogFile
            DatabaseConfig.ParamTable[222] = new ParamDef(222, false, false, typeof(bool)); // JET_paramFlight_SessionSharingViolationValidation
            DatabaseConfig.ParamTable[224] = new ParamDef(224, false, false, typeof(bool)); // JET_paramFlight_EnableBTNewImpl
            DatabaseConfig.ParamTable[225] = new ParamDef(225, false, false, typeof(bool)); // JET_paramFlight_ForceEnableBBT
            DatabaseConfig.ParamTable[226] = new ParamDef(226, false, false, typeof(int)); // JET_paramFlight_LogWaitForSpace
            DatabaseConfig.ParamTable[227] = new ParamDef(227, true, false, typeof(int)); // JET_paramOutstandingDiskIOMax
            DatabaseConfig.ParamTable[228] = new ParamDef(228, true, false, typeof(int)); // JET_paramOutstandingFlashIOMax
            DatabaseConfig.ParamTable[229] = new ParamDef(229, false, false, typeof(int)); // JET_paramRBSMaxSizeGb
            DatabaseConfig.ParamTable[230] = new ParamDef(230, false, false, typeof(int)); // JET_paramRBSMaxDiskSpaceGb
            DatabaseConfig.ParamTable[231] = new ParamDef(231, false, false, typeof(int)); // JET_paramFlight_PageVoting
            DatabaseConfig.ParamTable[232] = new ParamDef(232, false, false, typeof(int)); // JET_paramFlight_RBSMaxConcurrentBuffersWrite
            DatabaseConfig.ParamTable[233] = new ParamDef(233, true, false, typeof(int)); // JET_paramMaxDiskCoalesceReadGapSize
            DatabaseConfig.ParamTable[234] = new ParamDef(234, true, false, typeof(int)); // JET_paramMaxFlashCoalesceReadGapSize
            DatabaseConfig.ParamTable[235] = new ParamDef(235, false, false, typeof(bool)); // JET_paramFlight_EnablePrereadAdditionalPage
            DatabaseConfig.ParamTable[236] = new ParamDef(236, false, false, typeof(bool)); // JET_paramFlight_EnablePassiveMonitor
            DatabaseConfig.ParamTable[237] = new ParamDef(237, false, false, typeof(int)); // JET_paramFlight_ReportIDIntervalSec
            DatabaseConfig.ParamTable[238] = new ParamDef(238, false, false, typeof(bool)); // JET_paramFlight_InternalPrereadUsingPrereadContext
            DatabaseConfig.ParamTable[239] = new ParamDef(239, true, false, typeof(int)); // JET_paramFlight_FlashPrereadBytesIndexRangeUsingPrereadContext
            DatabaseConfig.ParamTable[240] = new ParamDef(240, true, false, typeof(int)); // JET_paramFlight_FlashPrereadBytesPredictiveUsingPrereadContext
            DatabaseConfig.ParamTable[242] = new ParamDef(242, false, false, typeof(bool)); // JET_paramFlight_EnableConcCreateIndexNewFIARD
            DatabaseConfig.ParamTable[243] = new ParamDef(243, false, false, typeof(int)); // JET_paramFlight_RecoveryStallLogThreshold
            DatabaseConfig.ParamTable[244] = new ParamDef(244, false, false, typeof(int)); // JET_paramFlight_ProbeAllocatedBufferThreshold
            DatabaseConfig.ParamTable[245] = new ParamDef(245, false, false, typeof(int)); // JET_paramFlight_LogReplaySummaryIntervalSec
            DatabaseConfig.ParamTable[247] = new ParamDef(247, false, false, typeof(int)); // JET_paramFlight_CoherentCorruptionBlocks
            DatabaseConfig.ParamTable[248] = new ParamDef(248, true, false, typeof(bool)); // JET_paramFlight_EnableBravoLocks
            DatabaseConfig.ParamTable[249] = new ParamDef(249, false, false, typeof(bool)); // JET_paramFlight_EnableRfPScrubFix
        }
        ...
        /// <summary>
        /// Gets or sets Flight_AllowTempTableVersioningonPassives of type bool
        /// </summary>
        public bool Flight_AllowTempTableVersioningonPassives
        {
            get { return this.GetParam<bool>(55); }
            set { this.SetParam(55, value); }
        }

        /// <summary>
        /// Gets or sets ElasticWaypointLatency of type int
        /// </summary>
        public int ElasticWaypointLatency
        {
        ...
        /// <summary>
        /// IO urgent level for reverting the databases using RBS. Used to decide how many outstanding I/Os will be allowed.
        /// </summary>
        public int Flight_RBSRevertIOUrgentLevel
        {
            get { return this.GetParam<int>(58); }
            set { this.SetParam(58, value); }
        }

        /// <summary>
        /// Gets or sets Flight_EnableXpress10Compression of type bool
        /// </summary>
        public bool Flight_EnableXpress10Compression
        {
            get { return this.GetParam<bool>(59); }
            set { this.SetParam(59, value); }
        }
        ...
        /// <summary>
        /// Gets or sets Flight_RBSMaxTableDeletePages of type int
        /// </summary>
        public int Flight_RBSMaxTableDeletePages
        {
        ...
        /// <summary>
        /// Gets or sets Flight_RBSDbScanRaiseCorruptionRevertedFDP of type bool
        /// </summary>
        public bool Flight_RBSDbScanRaiseCorruptionRevertedFDP
        {
        ...
        /// <summary>
        /// Gets or sets Flight_RBSAllowTooSoonNonRevertableDelete of type bool
        /// </summary>
        public bool Flight_RBSAllowTooSoonNonRevertableDelete
        {
            get { return this.GetParam<bool>(75); }
            set { this.SetParam(75, value); }
        }
        ...
        /// <summary>
        /// Time after which we should force roll into new revert snapshot by raising failure item and letting HA remount. This is temporary till we have live roll.
        /// </summary>
        public int Flight_RBSForceRollIntervalSec
        {
            get { return this.GetParam<int>(80); }
            set { this.SetParam(80, value); }
        }
        ...
        /// <summary>
        /// Gets or sets Flight_EnableScanCheckFDPDeleteFlags of type bool
        /// </summary>
        public bool Flight_EnableScanCheckFDPDeleteFlags
        {
            get { return this.GetParam<bool>(83); }
            set { this.SetParam(83, value); }
        }
        ...
        /// <summary>
        /// Gets or sets Flight_MaxRBSBuffers of type int
        /// </summary>
        public int Flight_MaxRBSBuffers
        {
            get { return this.GetParam<int>(88); }
            set { this.SetParam(88, value); }
        }

        /// <summary>
        /// Gets or sets Flight_NodeOrderChecking of type int
        /// </summary>
        public int Flight_NodeOrderChecking
        {
            get { return this.GetParam<int>(89); }
            set { this.SetParam(89, value); }
        }

        /// <summary>
        /// Gets or sets Flight_EnableSpBuffOptimizations of type bool
        /// </summary>
        public bool Flight_EnableSpBuffOptimizations
        {
            get { return this.GetParam<bool>(90); }
            set { this.SetParam(90, value); }
        }

        /// <summary>
        /// Time after which we should roll into new rollback snapshot.
        /// </summary>
        public int Flight_RBSRollIntervalSec
        {
            get { return this.GetParam<int>(91); }
            set { this.SetParam(91, value); }
        }

        /// <summary>
        /// Whether we should raise RBSRollRequired failure item from ResetContainsDataFromFutureLogs. After reseed, we keep RBS disabled by default due to high required range.
        /// </summary>
        public bool Flight_EnableRBSRollRequiredPostRequiredRange
        {
            get { return this.GetParam<bool>(92); }
            set { this.SetParam(92, value); }
        }

        /// <summary>
        /// Turns on clean up for rollback snapshot.
        /// </summary>
        public bool Flight_RBSCleanupEnabled
        {
            get { return this.GetParam<bool>(93); }
            set { this.SetParam(93, value); }
        }

        /// <summary>
        /// Low disk space in gigabytes at which we will start cleaning up rollback snapshots aggressively.
        /// </summary>
        public int RBSLowDiskSpaceThresholdGb
        {
            get { return this.GetParam<int>(94); }
            set { this.SetParam(94, value); }
        }

        /// <summary>
        /// Max alloted space in gigabytes for rollback snapshots when the disk space is low.
        /// </summary>
        public int RBSMaxSpaceWhenLowDiskSpaceGb
        {
            get { return this.GetParam<int>(95); }
            set { this.SetParam(95, value); }
        }

        /// <summary>
        /// Max timespan of a rollback snapshot
        /// </summary>
        public int Flight_RBSMaxTimeSpanSec
        {
            get { return this.GetParam<int>(96); }
            set { this.SetParam(96, value); }
        }

        /// <summary>
        /// Min time between cleanup attempts of rollback snapshots.
        /// </summary>
        public int Flight_RBSCleanupIntervalMinSec
        {
            get { return this.GetParam<int>(97); }
            set { this.SetParam(97, value); }
        }
        ...
        /// <summary>
        /// Gets or sets Flight_ExtentPageCountCacheVerifyOnly of type bool
        /// </summary>
        public bool Flight_ExtentPageCountCacheVerifyOnly
        {
            get { return this.GetParam<bool>(114); }
            set { this.SetParam(114, value); }
        }

        /// <summary>
        /// Gets or sets Flight_EnablePgnoFDPLastSetTime of type bool
        /// </summary>
        public bool Flight_EnablePgnoFDPLastSetTime
        {
            get { return this.GetParam<bool>(115); }
            set { this.SetParam(115, value); }
        }

        /// <summary>
        /// Gets or sets Flight_EnableFDPDeleteFlagCheckOnExtentFreedRedo of type bool
        /// </summary>
        public bool Flight_EnableFDPDeleteFlagCheckOnExtentFreedRedo
        {
            get { return this.GetParam<bool>(116); }
            set { this.SetParam(116, value); }
        }

        /// <summary>
        /// Gets or sets Flight_RBSRaiseCorruptionOnRBSFDPToBeDeleted of type bool
        /// </summary>
        public bool Flight_RBSRaiseCorruptionOnRBSFDPToBeDeleted
        {
            get { return this.GetParam<bool>(117); }
            set { this.SetParam(117, value); }
        }

        /// <summary>
        /// Gets or sets Flight_RBSLargeRevertableDeletePages of type int
        /// </summary>
        public int Flight_RBSLargeRevertableDeletePages
        {
            get { return this.GetParam<int>(118); }
            set { this.SetParam(118, value); }
        }

        /// <summary>
        /// Gets or sets Flight_RBSRevertableDeleteIfTooSoonTimeNull of type bool
        /// </summary>
        public bool Flight_RBSRevertableDeleteIfTooSoonTimeNull
        {
            get { return this.GetParam<bool>(119); }
            set { this.SetParam(119, value); }
        }
        ...
        /// <summary>
        /// Gets or sets Flight_CacheTraceSamplingRatio of type int
        /// </summary>
        public int Flight_CacheTraceSamplingRatio
        {
            get { return this.GetParam<int>(185); }
            set { this.SetParam(185, value); }
        }
        ...
        /// <summary>
        /// Turns on rollback snapshot.
        /// </summary>
        public bool EnableRBS
        {
            get { return this.GetParam<bool>(215); }
            set { this.SetParam(215, value); }
        }

        /// <summary>
        /// This parameter indicates the relative or absolute file system path of the
        /// folder that will contain the rollback snapshots for the instance. The path must
        /// be terminated with a backslash character, which indicates that the target path
        /// is a folder.
        /// </summary>
        public string RBSFilePath
        {
            get { return this.GetParam<string>(216); }
            set { this.SetParam(216, value); }
        }

        /// <summary>
        /// Interval, in units of msec, used by the Permormance Monitor to refresh values for collection.
        /// </summary>
        public int PerfmonRefreshInterval
        {
            get { return this.GetParam<int>(217); }
            set { this.SetParam(217, value); }
        }

        /// <summary>
        /// Gets or sets Flight_BufferManagerChecking of type int
        /// </summary>
        public int Flight_BufferManagerChecking
        {
            get { return this.GetParam<int>(220); }
            set { this.SetParam(220, value); }
        }

        /// <summary>
        /// Whether we should allow log buffer larger than logfile size (upto 2x logfile size)
        /// </summary>
        public bool Flight_AllowLogBufferLargerThanLogFile
        {
            get { return this.GetParam<bool>(221); }
            set { this.SetParam(221, value); }
        }

        /// <summary>
        /// Whether we should validate that a session sharing violation is not occurring during jet api call.
        /// </summary>
        public bool Flight_SessionSharingViolationValidation
        {
            get { return this.GetParam<bool>(222); }
            set { this.SetParam(222, value); }
        }

        /// <summary>
        /// Enables the new BT implementation for classic BTs. Has no effect on BBTs (they always use the new impl).
        /// </summary>
        public bool Flight_EnableBTNewImpl
        {
            get { return this.GetParam<bool>(224); }
            set { this.SetParam(224, value); }
        }

        /// <summary>
        /// Forces all tables created to use BBTs. Only supported for materialized temp tables and the primary table. It's space/lv/index trees
        /// still use BTs.
        /// </summary>
        public bool Flight_ForceEnableBBT
        {
            get { return this.GetParam<bool>(225); }
            set { this.SetParam(225, value); }
        }

        /// <summary>
        /// Length of time in milliseconds to wait for free space in the log buffer before retrying an append of a transaction log record.
        /// </summary>
        public int Flight_LogWaitForSpace
        {
            get { return this.GetParam<int>(226); }
            set { this.SetParam(226, value); }
        }

        /// <summary>
        /// This parameter controls how many database file I/Os can be queued
        /// per hard disk in the host operating system at one time. A larger value
        /// for this parameter can significantly help the performance of a large
        /// database application. If the value is zero (the default) then the
        /// setting in JET_paramOutstandingIOMax takes precendence.
        /// </summary>
        public int OutstandingDiskIOMax
        {
            get { return this.GetParam<int>(227); }
            set { this.SetParam(227, value); }
        }

        /// <summary>
        /// This parameter controls how many database file I/Os can be queued
        /// per flash drive in the host operating system at one time. A larger value
        /// for this parameter can significantly help the performance of a large
        /// database application. If the value is zero (the default) then the
        /// setting in JET_paramOutstandingIOMax takes precendence.
        /// </summary>
        public int OutstandingFlashIOMax
        {
            get { return this.GetParam<int>(228); }
            set { this.SetParam(228, value); }
        }

        /// <summary>
        /// Maximum size the RBS will be allowed to grow before we try to do force rollover (assuming rollover time has passed).
        /// </summary>
        public int RBSMaxSizeGb
        {
            get { return this.GetParam<int>(229); }
            set { this.SetParam(229, value); }
        }

        /// <summary>
        /// Maximum space RBS snapshots are allowed to take up on the disk.
        /// </summary>
        public int RBSMaxDiskSpaceGb
        {
            get { return this.GetParam<int>(230); }
            set { this.SetParam(230, value); }
        }

        /// <summary>
        /// Gets or sets Flight_PageVoting of type int
        /// </summary>
        public int Flight_PageVoting
        {
            get { return this.GetParam<int>(231); }
            set { this.SetParam(231, value); }
        }

        /// <summary>
        /// Gets or sets Flight_RBSMaxConcurrentBuffersWrite of type int
        /// </summary>
        public int Flight_RBSMaxConcurrentBuffersWrite
        {
            get { return this.GetParam<int>(232); }
            set { this.SetParam(232, value); }
        }

        /// <summary>
        /// Maximum number of bytes that can be gapped for a coalesced read operation for hard disk. If the value is zero (the default) then the
        /// setting in JET_paramMaxCoalesceReadGapSize takes precendence.
        /// </summary>
        /// <remarks>
        /// max = 10MB
        /// </remarks>
        public int MaxDiskCoalesceReadGapSize
        {
            get { return this.GetParam<int>(233); }
            set { this.SetParam(233, value); }
        }

        /// <summary>
        /// Maximum number of bytes that can be gapped for a coalesced read operation for flash. If the value is zero (the default) then the
        /// setting in JET_paramMaxCoalesceReadGapSize takes precendence.
        /// </summary>
        /// <remarks>
        /// max = 10MB
        /// </remarks>
        public int MaxFlashCoalesceReadGapSize
        {
            get { return this.GetParam<int>(234); }
            set { this.SetParam(234, value); }
        }

        /// <summary>
        /// Whether we should preread an additional page beyond the range so that ErrBTNext doesn't need to issue single page preread.
        /// </summary>
        public bool Flight_EnablePrereadAdditionalPage
        {
            get { return this.GetParam<bool>(235); }
            set { this.SetParam(235, value); }
        }

        /// <summary>
        /// Master enable for the ESE passive monitoring.
        /// </summary>
        public bool Flight_EnablePassiveMonitor
        {
            get { return this.GetParam<bool>(236); }
            set { this.SetParam(236, value); }
        }

        /// <summary>
        /// The interval for each kind of IDs to report in ESE passive monitoring, in seconds.
        /// </summary>
        public int Flight_ReportIDIntervalSec
        {
            get { return this.GetParam<int>(237); }
            set { this.SetParam(237, value); }
        }

        /// <summary>
        /// Whether we should do internal prereads using BTPrereadContext instead of reading remaining nodes in parent of leaf.
        /// </summary>
        public bool Flight_InternalPrereadUsingPrereadContext
        {
            get { return this.GetParam<bool>(238); }
            set { this.SetParam(238, value); }
        }

        /// <summary>
        /// Number of bytes to be preread on a SSD when index range is set and we want to preread using BTPrereadContext.
        /// Note that when using BTPrereadContext, we will have a preread queued even before we finish consuming the previous set of preread.
        /// </summary>
        /// <remarks>
        /// max = 100MB
        /// </remarks>
        public int Flight_FlashPrereadBytesIndexRangeUsingPrereadContext
        {
            get { return this.GetParam<int>(239); }
            set { this.SetParam(239, value); }
        }

        /// <summary>
        /// Number of bytes to be preread on a SSD when we predict the client is going to keep reading sequentially and we want to preread using BTPrereadContext.
        /// Note that when using BTPrereadContext, we will have a preread queued even before we finish consuming the previous set of preread.
        /// </summary>
        /// <remarks>
        /// max = 100MB
        /// </remarks>
        public int Flight_FlashPrereadBytesPredictiveUsingPrereadContext
        {
            get { return this.GetParam<int>(240); }
            set { this.SetParam(240, value); }
        }

        /// <summary>
        /// Enable new and imrpoved processing of FlagInsertAndReplaceData operations during concurrent create index.
        /// </summary>
        public bool Flight_EnableConcCreateIndexNewFIARD
        {
            get { return this.GetParam<bool>(242); }
            set { this.SetParam(242, value); }
        }

        /// <summary>
        /// The threshold to record recovery stall during log replay, in milliseconds, only opertaions took longer than it will be reported.
        /// </summary>
        public int Flight_RecoveryStallLogThreshold
        {
            get { return this.GetParam<int>(243); }
            set { this.SetParam(243, value); }
        }

        /// <summary>
        /// The threshold size above which we will probe a newly allocated buffer to trigger virtualalloc call.
        /// </summary>
        public int Flight_ProbeAllocatedBufferThreshold
        {
            get { return this.GetParam<int>(244); }
            set { this.SetParam(244, value); }
        }

        /// <summary>
        /// The interval to record log replay summary, in seconds.
        /// </summary>
        public int Flight_LogReplaySummaryIntervalSec
        {
            get { return this.GetParam<int>(245); }
            set { this.SetParam(245, value); }
        }

        /// <summary>
        /// A set of grbits that block certain ESE operations if the database header is marked with having experienced coherency corruptions within the file.
        /// </summary>
        public int Flight_CoherentCorruptionBlocks
        {
            get { return this.GetParam<int>(247); }
            set { this.SetParam(247, value); }
        }

        /// <summary>
        /// Enables the BRAVO protocol for enlightened locks.
        /// </summary>
        public bool Flight_EnableBravoLocks
        {
            get { return this.GetParam<bool>(248); }
            set { this.SetParam(248, value); }
        }

        /// <summary>
        /// Enables the fix for correct between read-from-passive transactions and 1-byte scrub of flag deleted nodes.
        /// </summary>
        public bool Flight_EnableRfPScrubFix
        {
            get { return this.GetParam<bool>(249); }
            set { this.SetParam(249, value); }
        }

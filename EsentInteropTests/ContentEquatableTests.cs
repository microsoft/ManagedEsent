...
namespace InteropApiTests
{
    ...
    public partial class ContentEquatableTests
    {
        ...
        public void VerifyJetRstinfoEquality()
        {
            ...
            {
                crstmap = 1,
                lgposStop = new JET_LGPOS { ib = 1, isec = 2, lgen = (JET_LGEN)3 },
        ...
        {
            DateTime now = DateTime.Now;
            JET_LGPOS lgpos = new JET_LGPOS { ib = 1, isec = 2, lgen = (JET_LGEN)3 };
            JET_PFNSTATUS status = (sesid, snp, snt, data) => JET_err.Success;
            ...
            int j = 1;
            values[j++].crstmap--;
            values[j++].lgposStop = new JET_LGPOS { ib = lgpos.ib, isec = lgpos.isec, lgen = lgpos.lgen + 1 };
